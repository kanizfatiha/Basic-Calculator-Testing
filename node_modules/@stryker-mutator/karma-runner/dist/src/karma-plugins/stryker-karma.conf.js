...
export const strykerKarmaConfigPath = path.resolve(path.dirname(filename), '..' /* karma-plugins */, '..' /* src */, '..' /* dist */, 'stryker-karma.conf.cjs');
...
async function setUserKarmaConfigFile(config, log, requireFromCwd) {
...
export async function configureKarma(config, requireFromCwd = requireResolve) {
